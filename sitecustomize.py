...
# If we install this package like "pip install -e .", then an absolute
# path to this directory will end up in sys.path, and this file will
# be imported whenever python is run.
#
# So, we only want to run coverage on code inside of this directory.
