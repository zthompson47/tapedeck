...
async def test_play_music(capsys, env_audio_dest, audio_uri):
    """Play a few seconds of music."""
    async with env_audio_dest as out:
        for track in [audio_uri['SONG'], audio_uri['RADIO']]:
...
async def test_play_music_better_way(env_audio_dest, audio_uri):
